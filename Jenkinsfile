    ...
    withCredentials([file(credentialsId: JWT_KEY_CRED_ID, variable: 'jwt_key_file')]) {
        ...
        stage('Deploye Code'){
            ...
            if (isUnix()) {
                ...
                rmsg = bat returnStdout: true, script: "sfdx force:mdapi:deploy -d c:/Usama Khalid/MyStandardOrgData/MySalesforce-LocalRepo-/force-app/main/default/classes/TaskUtil.cls -u ${HUB_ORG}"
            }
        }
